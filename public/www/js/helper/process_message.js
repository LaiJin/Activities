...
var process_all_message = {
    ...
    process_message: function(json_message) {
        judge_message(this.synchronous_new_bid_sign_up, this.synchronous_new_activity_bid_sign_up, json_message)
    }

}


function judge_message(synchronous_new_bid_sign_up, synchronous_new_activity_sign_up, json_message) {
    var message = json_message.messages[0]
    message.content = trim(message.content)
    var fore_two_string = message.content.substring(0, 2).toUpperCase()
    var judge_message = {
        BM: function() {
            process_activity_sign_up_message(synchronous_new_activity_sign_up, message)
        },

        JJ: function() {
            process_bid_sign_up_message(synchronous_new_bid_sign_up, message)
        }
    }
...
function process_activity_sign_up_message(synchronous_new_activity_sign_up, message) {
    ...
    function add_new_activity_sign_up_info() {
        var activity_sign_up_person_name = trim_price_or_person_name(message)
...
function process_bid_sign_up_message(synchronous_new_bid_sign_up, message) {
    ...
    function add_new_bid_sign_up_info(activity_sign_up_info) {
        var bid_sign_up_price = trim_price_or_person_name(message)
...
function trim_price_or_person_name(message) {
