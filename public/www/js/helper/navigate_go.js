...
var navigate_go = {
    mobile_client_user_login_view: function(navigate) {navigate.go('mobile_client_user_login_view', 'slide')},
            ...
            activity_sign_up_view: function(navigate) {navigate.go('activity_sign_up_view', 'slide')},
                 ...
                 bid_sign_up_view: function(navigate) {navigate.go('bid_sign_up_view', 'slide')},
              bid_statistics_view: function(navigate) {navigate.go('bid_statistics_view', 'slide')},
                  bid_result_view: function(navigate) {navigate.go('bid_result_view', 'slide')}
}